  ...
  return (
    ...
    <div className="influencer-main">
        ...
        <Button className={showFilter ? "outlinedBtn cmmBtn active" : "outlinedBtn cmmBtn" } onClick={() => setShowFilter(prevState => !prevState)}>
            ...
            <Button className="primBtn cmmBtn"  onClick={handleShow}>Add to Campaign</Button>
        </div>
        </div>
        ...
        <div className="headInfi">
            ...
            {selectAll && <Button className="primBtn cmmBtn">Update</Button>}
        </div>
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <div className="addCamCont">
            <Button className="primBtn cmmBtn" onClick={() => handleCampModal("Add")}>Add to existing campaign</Button>
            <Button className="primBtn cmmBtn" onClick={() => handleCampModal("New")}>Create a new campaign</Button>
        </div>
        </Modal.Body>
    </Modal>
